...
# if defined key_zdfgls
            ...
            zw2d(:,:) = tn_25h(:,:,1)*tmask(:,:,1) + zmdi*(1.0-tmask(:,:,1))
            CALL iom_put("temper25h", zw3d)   ! potential temperature
            CALL iom_put("sst25h", zw2d)   ! potential temperature
            ...
            zw2d(:,:) = sn_25h(:,:,1)*tmask(:,:,1) + zmdi*(1.0-tmask(:,:,1))
            CALL iom_put( "salin25h", zw3d  )   ! salinity
            CALL iom_put( "sss25h", zw2d  )   ! salinity
